<template>
  <el-container class="lp-page">
    <el-header class="lp-page__header"
      ><div class="title">排版设计神器V1.0</div>
      <div class="btn-group">
        <!-- <div class="btn-item" @click="renderImg">
        ...
        <img :src="imgUrl" style="width: 50px" /></div
    ></el-header>
    <el-container class="lp-page__body">
      <el-aside width="250px" class="editor__left">
      ...
      ></el-main>
      <el-aside width="300px" class="editor__left">
...
export default {
  ...
  methods: {
    async renderImg() {
      ...
      this.$store.commit("imgHtml", shareContent);
      // console.log(this.$store.state.imgHtml);
